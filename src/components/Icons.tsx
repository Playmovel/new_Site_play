...
export default function SobreZyber() {
  ...
  const WifiIcon = () => (
    <svg width="180" height="180" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 18C10.9 18 10 18.9 10 20C10 21.1 10.9 22 12 22C13.1 22 14 21.1 14 20C14 18.9 13.1 18 12 18ZM16.23 14.77C15.05 13.59 13.57 13 12 13C10.43 13 8.95 13.59 7.77 14.77L6.36 13.36C7.92 11.8 9.96 11 12 11C14.04 11 16.08 11.8 17.64 13.36L16.23 14.77ZM19.07 11.93C17.14 10 14.61 9 12 9C9.39 9 6.86 10 4.93 11.93L3.52 10.52C5.81 8.23 8.88 7 12 7C15.12 7 18.19 8.23 20.48 10.52L19.07 11.93ZM21.91 9.09C19.25 6.43 15.69 5 12 5C8.31 5 4.75 6.43 2.09 9.09L0.68 7.68C3.68 4.68 7.75 3 12 3C16.25 3 20.32 4.68 23.32 7.68L21.91 9.09Z" fill="url(#gradient1)"/>
      <defs>
  ...
  const SignalIcon = () => (
    <svg width="180" height="180" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 22H4V18H2V22ZM6 22H8V14H6V22ZM10 22H12V10H10V22ZM14 22H16V6H14V22ZM18 22H20V2H18V22Z" fill="url(#gradient2)"/>
      <defs>
    ...
    <Section id="sobre">
      <Container>
        ...
        <div style={{
          ...
          width: '400px',
          height: '400px',
          background: 'radial-gradient(circle, var(--yellow-alpha-15) 0%, transparent 80%)',
          borderRadius: '50%',
          filter: 'var(--blur-xl)',
        ...
        <div style={{
          ...
          width: '200px',
          height: '2px',
          background: 'linear-gradient(90deg, transparent, var(--primary-alpha-30), transparent)',
...
const SectionTitle = styled.h2`
  ...
  @keyframes titleGlow {
    0%, 100% { filter: drop-shadow(0 0 10px var(--primary-alpha-20)); }
    50% { filter: drop-shadow(0 0 20px var(--primary-alpha-30)); }
  }
