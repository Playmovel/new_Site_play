...
export default function Footer() {
  ...
  const hasActiveSocialLinks = redesSociais && (
    ...
    (redesSociais.bool_whatsapp && redesSociais.whatsapp)
  )
        ...
        <>
          ...
          <SocialSection>
            ...
            <SocialLinks>
              ...
              {redesSociais?.bool_whatsapp && redesSociais.whatsapp && (
                <SocialLink href={redesSociais.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
